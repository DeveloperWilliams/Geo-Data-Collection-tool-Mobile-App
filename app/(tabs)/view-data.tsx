...
const ViewProjectScreen = () => {
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      projectData.vesPoints.forEach((ves, index) => {
        ...
        // Add auto-filter and column widths for better quality
        vesSheet['!autofilter'] = { ref: "A1:F1" };
        vesSheet['!cols'] = [
          { wch: 15 }, { wch: 15 }, { wch: 15 }, { wch: 10 }, { wch: 20 }, { wch: 15 }
        ];
      ...
      const uri = FileSystem.cacheDirectory + `${projectData.name.replace(/\s+/g, '_')}_VES_Data.xlsx`;
      ...
      await Sharing.shareAsync(uri, {
        ...
        dialogTitle: `Export ${projectData.name} VES Data`,
        UTI: 'com.microsoft.excel.xlsx'
      });
      
    } catch (error) {
      console.error("Export error:", error);
      Alert.alert("Export Failed", "Could not export project data to Excel");
    } finally {
  ...
  return (
    <ScrollView contentContainerStyle={localStyles.container}>
      ...
      {/* VES Navigation with improved UI */}
      <Animatable.View
        animation="fadeInUp"
        delay={300}
      ...
      >
        ...
        <View style={localStyles.tableContainer}>
          ...
          <View style={localStyles.tableRow}>
            ...
            <Text style={[localStyles.tableHeader, { flex: responsiveLayout ? 0.7 : 0.7 }]}>M.N (m)</Text>
